...
function cometMessageReceivedFromServer(message) {
  ...
  // I need to route this message to the appropriate place
  ...
  switch (page) {
    ...
    case '/user/index':
      ...
      if (message.verb === 'update') {
        UserIndexPage.updateUser(userId, message); //UserIndexPage is a custom object
      }
...
var UserIndexPage = {
  ...
  updateUser: function(id, message) {
    if(message.data.loggedIn) {
      //var $userRow = $('tr[data-id="' + id + '"] td img').first();   //this selector did not work for me
      //$userRow.attr('src', "/images/online.png");
      var selectorString = "#" + id;
      $(selectorString).attr('src', "/images/online.png");
    } else {
      //var $userRow = $('tr[data-id="' + id + '"] td img').first();
      //$userRow.attr('src', "/images/offline.png");
      var selectorString = "#" + id;
      $(selectorString).attr('src', "/images/offline.png");
    }
  },
  ...
  addUser: function(user) {
    ...
    console.log("made it into create");

    //obj is going to encompass both the new user data as well as the _csrf
    //info form the layout.ejs file
    var obj = {
        user: user.data,
        _csrf: window.overlord.csr || ''
    };
  ...
  destroyUser: function(id) {
    ...
    var selectorString = "#" + id;
      $(selectorString).parent().parent().remove();
